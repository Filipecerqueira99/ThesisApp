<template>
    ...
    <div class="blockExplanation">
        ...
        <div class="answerCorrect" v-if="parseInt(this.numberAnswersCorrect) >= 4">Que resultado Fantástico! Ótimo trabalho! 🎉</div>
        <div class="answerMid" v-if="parseInt(this.numberAnswersCorrect) == 3">Estás a meio caminho do sucesso! Continua a esforçar-te, cada passo é um progresso. 🚀</div>
...
export default {
    ...
    async created() {
        ...
        this.numberAnswersCorrect = localStorage.getItem('numberAnswersCorrect');
    },
    methods: {
        goBack() {
